...
- [x] Burning cost and fitted EL shown per zone with Q-Q plot; technical EL takes the max
- [x] Distribution choice switchable; fit updates
- [x] Loadings editor with three bases; live premium recomputation; gross-up verified against hand-calculated cases
- [x] Data-quality flag from the pricing year range displayed and stored
- [x] Golden tests: hand-computed burning cost, EL, and loading chains
- [x] Fit sanity test: synthetic data from known gamma recovers parameters within tolerance
